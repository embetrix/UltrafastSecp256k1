...
// ============================================================================
// 10x26-bit Field Element for secp256k1 (Lazy-Reduction for 32-bit Platforms)
// ============================================================================
//
// Alternative representation: 10 limbs x 26 bits each in uint32_t[10].
...
//   Mul/Sqr   = native 10x26 with inline secp256k1 reduction
//
...
//
// This is the 32-bit counterpart of FieldElement52 (5x52 for 64-bit CPUs).
// Targets: ESP32 (Xtensa LX6/LX7), STM32 (Cortex-M3/M4), any 32-bit CPU.
//
//   FieldElement   (4x64) -> optimal for: 64-bit CPUs, serialization, I/O
//   FieldElement52 (5x52) -> optimal for: 64-bit ECC point ops (lazy adds)
//   FieldElement26 (10x26)-> optimal for: 32-bit ECC point ops (lazy adds)
//
...
struct alignas(4) FieldElement26 {
    ...
    // 10x26 bit layout: [bits 0..25] [26..51] [52..77] [78..103]
