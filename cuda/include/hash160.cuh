...
__device__ __forceinline__ void ripemd160_32(const uint8_t data[32], uint8_t out[20]) {
    static __device__ __constant__ uint8_t r[80] = {
    ...
    static __device__ __constant__ uint8_t r2[80] = {
    ...
    static __device__ __constant__ uint8_t s[80] = {
    ...
    static __device__ __constant__ uint8_t s2[80] = {
    ...
    static __device__ __constant__ uint32_t K[5] = {
        0x00000000U, 0x5A827999U, 0x6ED9EBA1U, 0x8F1BBCDCU, 0xA953FD4EU
    };
    static __device__ __constant__ uint32_t K2[5] = {
